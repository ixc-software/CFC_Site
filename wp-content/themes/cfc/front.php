    ...
    <div class="social-box">
        ...
        <div id="share-box" style="height:50px;margin-top: 10px">
            ...
            <div class="share-container clearfix">
                ...
                <ul class="rrssb-buttons clearfix rrssb-1" style="margin:0;">

                    <li class="rrssb-facebook  " data-initwidth="14.285714285714286" data-size="64" style="width: 33%;">
                    ...
                    <li class="rrssb-twitter" data-initwidth="14.285714285714286" data-size="50" style="width: 33%;">
                    ...
                    <li class="rrssb-googleplus" data-initwidth="14.285714285714286" data-size="56" style="width: 33%;">
                        <!-- Replace href with your meta and URL information.  -->
